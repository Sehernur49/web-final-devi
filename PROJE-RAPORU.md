...
# Ruby on Rails Twitter Klonu

> **Proje Kodu:** P10 · **Zorluk:** Orta · **Puan:** 45 · **Hafta:** 1

**Öğrenci:** SEHERNUR ARIFİNAN  
**Öğrenci No:** 24080410030  
**E-posta:** sehernur.arifinan@gmail.com  
...
| Alan | Değer |
|------|-------|
| Proje Adı | Ruby on Rails Twitter Klonu |
| Proje Kodu | P10 |
...
| GitHub | https://github.com/KULLANICI_ADI/final-p10-ruby-on-rails-t |
| Canlı Demo | https://ruby-on-rails-twitter-klonu.vercel.app |
...
| Frontend | Hotwire (Turbo + Stimulus), Tailwind CSS 4, importmap-rails (no-build) |
| Database | PostgreSQL 16 |
| Realtime | ActionCable / Turbo Streams |
| Queue | Solid Queue (Rails 8 built-in) |
| Cache | Solid Cache |
| Deployment | Kamal 2 (Rails 8 deploy tool), Hetzner / DigitalOcean |
...
```mermaid
flowchart LR
    User(("👤 Rails developer / indie micro-blog kullanıcısı"))
    System["<b>Ruby on Rails Twitter Klonu</b>"]
